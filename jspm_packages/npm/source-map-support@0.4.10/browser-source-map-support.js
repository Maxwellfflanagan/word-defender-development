  ...
  (this.define || function(N, O) {
    ...
    (function p(v, l, b) {
      ...
      3: [function(p, v, l) {
        ...
        function t(g, m, c, a, f) {
          f || (q(void 0 !== m && null !== m, "missing value"), q("boolean" === typeof a, "missing or invalid endian"), q(void 0 !== c && null !== c, "missing offset"), q(c + 1 < g.length, "trying to write beyond buffer length"), H(m, 65535));
          var y = g.length;
          if (!(c >= y))
            for (f = 0, y = Math.min(y - c, 2); f < y; f++)
              g[c + f] = (m & 255 << 8 * (a ? f : 1 - f)) >>> 8 * (a ? f : 1 - f);
        }
        function c(g, c, a, f, b) {
          b || (q(void 0 !== c && null !== c, "missing value"), q("boolean" === typeof f, "missing or invalid endian"), q(void 0 !== a && null !== a, "missing offset"), q(a + 3 < g.length, "trying to write beyond buffer length"), H(c, 4294967295));
          var m = g.length;
          if (!(a >= m))
            for (b = 0, m = Math.min(m - a, 4); b < m; b++)
              g[a + b] = c >>> 8 * (f ? b : 3 - b) & 255;
        }
        function f(g, c, a, f, b) {
          b || (q(void 0 !== c && null !== c, "missing value"), q("boolean" === typeof f, "missing or invalid endian"), q(void 0 !== a && null !== a, "missing offset"), q(a + 1 < g.length, "Trying to write beyond buffer length"), z(c, 32767, -32768));
          a >= g.length || (0 <= c ? t(g, c, a, f, b) : t(g, 65535 + c + 1, a, f, b));
        }
        function G(g, m, a, f, b) {
          b || (q(void 0 !== m && null !== m, "missing value"), q("boolean" === typeof f, "missing or invalid endian"), q(void 0 !== a && null !== a, "missing offset"), q(a + 3 < g.length, "Trying to write beyond buffer length"), z(m, 2147483647, -2147483648));
          a >= g.length || (0 <= m ? c(g, m, a, f, b) : c(g, 4294967295 + m + 1, a, f, b));
        }
        function u(g, c, a, f, b) {
          b || (q(void 0 !== c && null !== c, "missing value"), q("boolean" === typeof f, "missing or invalid endian"), q(void 0 !== a && null !== a, "missing offset"), q(a + 3 < g.length, "Trying to write beyond buffer length"), E(c, 3.4028234663852886E38, -3.4028234663852886E38));
          a >= g.length || J.write(g, c, a, f, 23, 4);
        }
        function M(g, c, a, f, b) {
          b || (q(void 0 !== c && null !== c, "missing value"), q("boolean" === typeof f, "missing or invalid endian"), q(void 0 !== a && null !== a, "missing offset"), q(a + 7 < g.length, "Trying to write beyond buffer length"), E(c, 1.7976931348623157E308, -1.7976931348623157E308));
          a >= g.length || J.write(g, c, a, f, 52, 8);
        }
        function I(g, c, a) {
          if ("number" !== typeof g)
            return a;
        ...
        function x(g) {
          for (var c = [],
            ...
            if (127 >= f)
              ...
              var b = a;
              55296 <= f && 57343 >= f && a++;
              f = encodeURIComponent(g.slice(b, a + 1)).substr(1).split("%");
              for (b = 0; b < f.length; b++)
                c.push(parseInt(f[b], 16));
            }
          }
          return c;
        }
        ...
        function B(g, c, a, f) {
          for (var m = 0; m < f && !(m + a >= c.length || m >= g.length); m++)
            c[m + a] = g[m];
          return m;
        }
        function F(g) {
        ...
        b.prototype.slice = function(g, c) {
          var a = this.length;
          g = I(g, a, 0);
          c = I(c, a, a);
          if (b._useTypedArrays)
            return b._augment(this.subarray(g, c));
          for (var a = c - g,
              f = new b(a, void 0, !0),
              m = 0; m < a; m++)
            f[m] = this[m + g];
